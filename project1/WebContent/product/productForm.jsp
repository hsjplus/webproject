...
<head>
	...
	<body>
        ...
        <form class="form-signin" method="post" action="pwrite.jsp" enctype = "multipart/form-data">
       		 <h2 class="form-signin-heading">상품 정보 입력</h2>
       		 상품 이름 : <input type="text" name="pname" /> <br/>
        	 가격 : <input type="text" name="price" /> <br/>
        	 상품소개: <input type="text" name="pcontent" /><br/>
        	 상품종류: <input type="text" name="ptype" /><br/>
        	 이미지 추가: <input type="file"  name="p" /><br/> 
      		 <button class="btn btn-sm btn-primary btn-block" type="submit">입력</button>
	     </form>
	    </div>
